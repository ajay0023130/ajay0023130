...
## 💫 About Me
I’m **Ajay**, a **Senior Python Full-Stack Engineer** with **4+ years of hands-on experience** building **scalable, secure, and high-performance web applications**. I specialize in **backend architecture, API design, and system scalability**, while also delivering clean, modern, and user-centric frontends.

I work extensively with **Django, FastAPI, Django REST Framework (DRF), Next.js, and AWS**, focusing on **clean architecture, performance optimization, and production-ready deployments**. I enjoy owning features end-to-end and collaborating with cross-functional teams to ship reliable and maintainable solutions.
...
## 📌 Current Focus
- Designing and scaling **backend architectures** for production-grade applications  
- Building **secure, high-performance REST APIs** using Django & FastAPI  
- Developing **full-stack features** with Next.js and modern UI patterns  
